...
function _updateConfig() {
    ...
    for (b = 0; b < a.length; b++) switch (_keyValuePair = decodeURIComponent(a[b].toLowerCase()), _key = _keyValuePair.split("=")[0], _value = _keyValuePair.split("=")[1], _key) {
        ...
        case "enhlink":
            ...
            break;
        case "optout":
            if (_value = _cleanBooleanParam(_value), !0 === _value || !1 === _value) oCONFIG.OPTOUT_PAGE = _value
    }
}
...
function gas(a, b, c, d, f, e, h) {
    if (void 0 !== a && "" !== a && void 0 !== b && "" !== b && void 0 !== c && "" !== c)
        if ("pageview" === b.toLowerCase()) try {
            ...
            _sendEvent(c, d, void 0 === f ? "" : f, void 0 === e || "" === e || isNaN(e) ? 0 : parseInt(e), g)
...
function createTracker(a) {
    for (var b = 0; b < oCONFIG.GWT_UAID.length; b++) {
        ...
        if (oCONFIG.ANONYMIZE_IP) window[window.GoogleAnalyticsObject](oCONFIG.PUA_NAME + b + ".set", "anonymizeIp",
        ...
        oCONFIG.USE_MAIN_CUSTOM_DIMENSIONS && 0 === b && (window[window.GoogleAnalyticsObject](oCONFIG.PUA_NAME +
        ...
        oCONFIG.USE_PARALLEL_CUSTOM_DIMENSIONS && 0 < b && (window[window.GoogleAnalyticsObject](oCONFIG.PUA_NAME + b + ".set", oCONFIG.PARALLEL_AGENCY_CUSTOM_DIMENSION_SLOT,
